...
@given(
    parsers.re(
        r"a user with the domain (?P<domain>[a-zA-Z0-9\.]+) and subscription key (?P<api_key>\w+)"
    ),
...
@when(
    'I fill in the "Ocp-Apim-Subscription-Key" with "99e9cb10e8c04ea0b788334dc6346f13"'
)
...
@when(
    'I fill in the "Ocp-Apim-Subscription-Key" with "f83xx8d8xx6749f19a26e2265aeadbcdeg"'
)
def fill_key():
    return
