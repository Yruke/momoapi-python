...
class Collection(MomoApi, object):
    ...
    def getBalance(self):
        ...
        return super(Collection, self).getBalance(
            url, super(Collection, self).config.collectionsKey
        )
    ...
    def requestToPay(
        ...
        **kwargs,
        ...
        url = "{0}/collection/v1_0/requesttopay".format(
            super(Collection, self).config.baseUrl
        )
